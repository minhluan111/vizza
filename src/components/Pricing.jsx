...
export default function Pricing() {
  const tiers = [
    ...
    },
    {
      ...
      price: '6.500.000 đ',
      period: 'trọn gói',
      desc: 'Được lựa chọn nhiều nhất. Tối ưu khâu đặt chỗ thông qua sơ đồ chọn vị trí qua hình ảnh thực tế.',
      features: [
        'Bao gồm toàn bộ tính năng của gói Starter',
        'Hệ thống chọn vị trí đặt bàn qua ảnh không gian',
        'Cấu hình ảnh và thông số bàn trực quan',
        'Hệ thống quản trị (Admin) xem và cập nhật trạng thái bàn',
        'Gửi email xác nhận đặt chỗ tự động cho khách hàng',
        'Thống kê lượng đặt chỗ chi tiết hàng tuần/hàng tháng',
        'Hỗ trợ kỹ thuật và bảo hành hệ thống 6 tháng',
      ],
      cta: 'Được khuyên dùng',
      popular: true,
    ...
    <section id="pricing" className="section section-bg-alt">
      <div className="container">
        ...
        <div className="section-header">
          ...
          <h2 className="section-title">Chi Phí Đầu Tư <span className="text-gradient">Hợp Lý & Tiết Kiệm</span></h2>
          <p className="section-subtitle" style={{ marginTop: '10px' }}>
            Chúng tôi thiết lập các gói dịch vụ với chi phí cạnh tranh nhất, giúp quán cafe/nhà hàng của bạn nhanh chóng sở hữu website chuyên nghiệp.
          </p>
        </div>
          ...
          {tiers.map((tier, index) => (
            <div
              ...
              style={{
                ...
                background: '#ffffff',
                boxShadow: tier.popular ? 'var(--shadow-glow)' : 'var(--shadow-md)',
              }}
            >
              {/* Popular Badge */}
              {tier.popular && (
                ...
                <div style={{
                  ...
                  <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '14px' }}>
                    {tier.features.map((feat, fIndex) => (
                      <li key={fIndex} style={{ display: 'flex', gap: '10px', alignItems: 'flex-start', fontSize: '0.9rem' }}>
                        <div style={{
                          ...
                          color: tier.popular ? 'var(--secondary)' : 'var(--primary)',
                          marginTop: '2px',
                          flexShrink: 0,
                        }}>
                          <Check size={12} />
