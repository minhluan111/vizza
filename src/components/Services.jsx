      ...
      <div className="container">
        ...
        <div className="section-header">
          ...
          <p className="section-subtitle" style={{ marginTop: "10px" }}>
            Không còn đặt bàn mơ hồ. Chúng tôi cung cấp giải pháp đặt bàn tương
            tác qua hình ảnh thực tế, giúp khách hàng chọn đúng góc ngồi ưng ý
            nhất.
          </p>
        </div>
        ...
        <div className="grid-3" style={{ marginBottom: "60px", gap: "24px" }}>
          <div
            ...
            style={{ padding: "24px", textAlign: "left", background: "#fff" }}
          >
            <h3
              style={{
                fontSize: "1.15rem",
            ...
            <p style={{ fontSize: "0.88rem", color: "var(--text-secondary)" }}>
              Giúp khách hàng hình dung rõ nét góc view, ánh sáng và kiểu ghế
              ngồi thông qua ảnh chụp thực tế từng ngóc ngách của quán.
            </p>
          </div>
          ...
          >
            ...
            <p style={{ fontSize: "0.88rem", color: "var(--text-secondary)" }}>
              Nhân viên không cần tư vấn dài dòng qua điện thoại về vị trí bàn.
              Mọi thông tin trực quan đều hiển thị rõ ràng trên màn hình.
            </p>
          </div>
          ...
          >
            ...
            <p style={{ fontSize: "0.88rem", color: "var(--text-secondary)" }}>
              Khách hàng cảm thấy an tâm và hào hứng hơn khi biết chính xác bàn
              mình sẽ ngồi có view đẹp hay yên tĩnh như thế nào trước khi tới.
            </p>
          </div>
        </div>
        ...
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          ...
          >
            Hãy click chọn các khu vực dưới đây để ngắm nhìn hình ảnh thực tế và
            chọn bàn trống.
          </p>
        </div>
          ...
          >
            {zones.map((zone) => (
              <button
                ...
                style={{
                  background:
                    activeZoneId === zone.id ? "var(--primary)" : "transparent",
                  border:
                    activeZoneId === zone.id
                      ? "1px solid var(--primary)"
                      : "1px solid var(--border)",
                  color:
                    activeZoneId === zone.id ? "#fff" : "var(--text-secondary)",
            ...
            >
                ...
                >
                  {timeSlots.map((time) => (
                    <button
                      ...
                      style={{
                        background:
                          selectedTime === time ? "var(--primary)" : "#fff",
                        border:
                          selectedTime === time
                            ? "1px solid var(--primary)"
                            : "1px solid var(--border)",
              ...
              {bookingSuccess && (
                ...
                >
                  ...
                  >
                    {selectedTable.name} ({activeZone.name}) lúc {selectedTime}{" "}
                    đã được đặt thử nghiệm thành công cho bạn. Giao diện demo
                    hoạt động đúng luồng!
                  </p>
                </div>
              )}
            </div>
