...
import { MessageSquare, ShieldCheck, Milestone, CheckCircle2 } from 'lucide-react';
...
export default function Payment() {
  ...
  return (
    <section id="payment" className="section">
      <div className="glow-orb glow-orb-secondary animate-pulse-slow" style={{ left: '10%' }}></div>
      
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        {/* Section Header */}
        <div className="section-header">
          <span className="badge">Quy Trình Hợp Tác</span>
          <h2 className="section-title">Thanh Toán Linh Hoạt <span className="text-gradient">Theo Thỏa Thuận</span></h2>
          <p className="section-subtitle" style={{ marginTop: '10px' }}>
            Chúng tôi hiểu mỗi doanh nghiệp F&B đều có tiến độ dòng tiền riêng. Mọi điều khoản về thanh toán đều được thảo luận thân thiện và điều chỉnh linh hoạt theo ý kiến hai bên.
          </p>
        </div>
                ...
                >
                  ...
                  >
                    <div className="glass-card" style={{
                      ...
                      <h4 style={{ fontSize: '1.15rem', marginBottom: '8px', fontWeight: 700, color: 'var(--text-primary)' }}>
                        {step.title}
                      </h4>
                  ...
                  {/* Right Column */}
                  <div style={{ width: '45%', order: isEven ? 3 : 1 }} className="timeline-empty-side"></div>
                </div>
              );
            })}
          </div>
        ...
        <div className="glass-card" style={{
          ...
          margin: '60px auto 0',
          padding: '24px',
          background: 'linear-gradient(135deg, rgba(181, 130, 87, 0.05) 0%, rgba(140, 154, 112, 0.05) 100%)',
          borderColor: 'var(--border)',
          textAlign: 'center',
        }}>
          <h4 style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', fontSize: '1.05rem', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '8px' }}>
            <CheckCircle2 size={18} style={{ color: 'var(--secondary)' }} />
            Cam kết đồng hành từ Vizza Team
          </h4>
          <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', maxWidth: '620px', margin: '0 auto' }}>
            Chúng tôi đảm bảo chất lượng lập trình sạch, bàn giao đầy đủ mã nguồn và hướng dẫn quản trị chi tiết. Đồng hành bảo trì miễn phí trong suốt thời gian bảo hành hợp đồng.
          </p>
        </div>
      </div>
